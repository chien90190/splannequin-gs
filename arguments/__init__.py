...
class ModelHiddenParams(ParamGroup):
    def __init__(self, parser):
        ...
        self.time_smoothness_weight = 0.1 # 0.01 TV loss of temporal grid
        self.l1_time_planes = 0.0005  # 0.0001 TV loss of temporal grid
        self.kplanes_config = {
                             'grid_dimensions': 2,
...
class OptimizationParams(ParamGroup):
    def __init__(self, parser):
        ...
        self.use_equality=True
        self.hidden_from_iter = 10_000
        self.l1_hidden_from_iter = 20_000
        self.l1_hidden_weight = 10
        self.l2_hidden_weight = 10
        self.hidden_percentage = 0.0
        self.hidden_interval = 10
        self.hidden_steepness = 3

        self.use_color_grad=True
        self.color_grad_coarse_iter = 0
        self.color_grad_coarse_weight = 1.5
        self.color_grad_fine_iter = 5000
        self.color_grad_fine_weight = 1

        self.occlusion_from_iter = 10_000
        self.l1_occlusion_from_iter = 20_000
        self.l1_occlusion_weight = 1e1
        self.l2_occlusion_weight = 1e1
        self.occlusion_percentage = 0.0
        self.occlusion_interval = 10
        self.occlusion_steepness = 3

        self.timestamp_shift = 0.0
        self.timestamp_reverse = 1.0 # -1.0 is reverseing timestamps
